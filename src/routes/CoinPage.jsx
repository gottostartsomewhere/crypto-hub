 ...
 ;
  ...
  return (
    <div className='rounded-div my-12 py-8'>
      ...
      <div className='grid md:grid-cols-2 gap-8'>
        <div>
          <div className='flex justify-between'>
            {coin.market_data?.current_price ? (
              <p className='text-3xl font-bold ml-3'>{coin.market_data.current_price.inr.toLocaleString()}</p>) :
              null}
            <p className='ml-3'>7 Day</p>
          </div>
          <div>
          ...
          <div className='grid grid-cols-2 gap-16'>
            ...
            <div className='mt-4 ml-24'>
              ...
              {coin.market_data?.total_volume ? (<p className='font-bold'>${coin.market_data.total_volume.usd.toLocaleString()}</p>) : null}
            </div>
            <div className='ml-2'>
        ...
        <div>
          ...
          <div className='flex justify-between py-4'>
            ...
            <div>
              <p className='mr-2 w-15'>Trust Score</p>
              {98.01}
            </div>
        </div>
        <div className='flex justify-between py-4'>
      ...
      <div className='my-8'>
        <p className='text-2xl font-bold mb-3 ml-2'>About {coin.name}</p>
        <p className=' ml-2 text-left'dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(coin.description ? coin.description.en : '') }}></p>
      </div>
    </div>
  );
};
